...
<div id="nav">
    <ul>
        ...
        <a target="_top" href="outdoor.jsp"><li>户外交友</li></a>
    </ul>
...
<div id ="signIn" >
    ...
    <form name="form1" action="" method="post">
        ...
        <a target="_top"><input type="button" class="button" value="注册" onclick="javascipt:location.href='../register/register.jsp'"/>
